...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER_MAIN] = LAYOUT_91_ansi(
        RGB_TOG, KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,  KC_CALC, KC_MPLY,
        ...
        XXXXXXX, OS_CMD,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,           KC_PGDN,
        XXXXXXX, KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_UP,
        XXXXXXX, T_CTLF4, KC_LALT, KC_LGUI, KC_SPC,           KC_SPC,                    KC_SPC,           KC_RGUI, KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_LAYER_SECONDARY] = LAYOUT_91_ansi(
        ...
        XXXXXXX, OS_CMD,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,           KC_PGDN,
        XXXXXXX, KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_UP,
        XXXXXXX, KC_LGUI, KC_LALT, KC_LCTL, KC_SPC,           KC_SPC,                    KC_SPC,           MO_WSP,  KC_RCTL, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
     ),
    ...
    [_LAYER_COMMANDS] = LAYOUT_91_ansi(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_TOG,
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, TO_MAIN, XXXXXXX, _K_RGB,  _K_MDTB, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          _K_MX_C,
        XXXXXXX, KC_CAPS, _K_MDA,  XXXXXXX, XXXXXXX, _K_AFN,  XXXXXXX, XXXXXXX, XXXXXXX, _K_MX_O, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX,          XXXXXXX,
        XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, _K_MDC,  XXXXXXX, _K_MDC2, KC_TILD, TO_SEC,  XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX,
...
bool rgb_matrix_indicators_user(void) {
    ...
    switch (current_layer) {
        case _LAYER_COMMANDS:
            ...
            // 23 caps : CMD
            rgb_matrix_set_color(23, _COLOR_WHITE);

            // 24 A : []()
            rgb_matrix_set_color(24, _COLOR_FN_KEYS);
            // 27 F : () => {}
            rgb_matrix_set_color(27, _COLOR_FN_KEYS);
            // 33 C : ```
            rgb_matrix_set_color(33, _COLOR_FN_KEYS);
            // 21 T : |---
            rgb_matrix_set_color(21, _COLOR_FN_KEYS);
            // 35 B : ```
            rgb_matrix_set_color(35, _COLOR_FN_KEYS);
            // 75 N : ~
            rgb_matrix_set_color(75, _COLOR_FN_KEYS);

            // 18 W : win layer
            rgb_matrix_set_color(18, _COLOR_WINDOWS);
            // 76 M : mac layer
            rgb_matrix_set_color(76, _COLOR_MAC);

            // 41 Space : sleep
            rgb_matrix_set_color(41, _COLOR_SLEEP);
            // 82 Space : sleep
            rgb_matrix_set_color(82, _COLOR_SLEEP);

            // 69 K keyboard metrics
            // 66 del clear keyboard
            ...
            // 56 backspace : QK_BOOT
            rgb_matrix_set_color(56, _COLOR_BOOTLOADER);
    ...
    if (host_keyboard_led_state().caps_lock) {
        rgb_matrix_set_color(57, _COLOR_WHITE); // PgUp
        rgb_matrix_set_color(66, _COLOR_WHITE); // PgDn
        rgb_matrix_set_color(74, _COLOR_WHITE); // Home
