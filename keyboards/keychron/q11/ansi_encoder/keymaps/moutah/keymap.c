...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER_MAIN] = LAYOUT_91_ansi(
        KC_MPLY, KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  HYPR_F13, OS_CMD,  KC_MPLY,
        ...
        HYPR_F5, T_CTLF4, KC_LALT, KC_LGUI, KC_LGUI,          KC_SPC,                    KC_SPC,           KC_RALT, KC_RCTL, XXXXXXX, KC_LEFT,  KC_DOWN, KC_RGHT
    ),
    ...
    [_LAYER_SECONDARY] = LAYOUT_91_ansi(
        ...
        HYPR_F3, OS_CMD,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,            KC_END,
        HYPR_F4, KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,  KC_UP,
        HYPR_F5, KC_LGUI, KC_LALT, KC_LCTL, KC_LCTL,          KC_SPC,                    KC_SPC,           KC_RCTL, KC_RGUI, XXXXXXX, KC_LEFT,  KC_DOWN, KC_RGHT
     ),
...
//    ),
    ...
    [_LAYER_COMMANDS] = LAYOUT_91_ansi(
        RGB_TOG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_MOD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT, XXXXXXX, XXXXXXX, RGB_TOG,
