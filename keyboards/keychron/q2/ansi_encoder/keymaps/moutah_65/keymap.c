...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ADVANCED] = LAYOUT_ansi_67(
        ...
        _______,          _______, RGB_SAD, _______, _______, _______, RGB_HUD, TO_MAC,  _______, RGB_VAD, _______,          _______, RGB_SPI,
        TO_LOK,  _______, _______,                            DB_TOGG,                            _______, _______, _______, RGB_RMOD,RGB_SPD, RGB_MOD
    ),
...
bool rgb_matrix_indicators_user(void) {
    ...
    switch (current_layer) {
        ...
        case _ADVANCED:
            ...
            // rgb functions
            rgb_matrix_set_color(32, _RGB_FUNCTION_COLOR);
            rgb_matrix_set_color(36, _RGB_FUNCTION_COLOR);
            rgb_matrix_set_color(39, _RGB_FUNCTION_COLOR);
            rgb_matrix_set_color(56, _RGB_FUNCTION_COLOR);
            rgb_matrix_set_color(64, _RGB_FUNCTION_COLOR);
            rgb_matrix_set_color(65, _RGB_FUNCTION_COLOR);
            rgb_matrix_set_color(66, _RGB_FUNCTION_COLOR);
