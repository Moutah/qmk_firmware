...
//        RGB_TOG, KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,  OS_CMD, KC_MPLY,
//        HYPR_F1, KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,          KC_PGUP,
//        HYPR_F2, KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,          KC_DEL,
//        HYPR_F3, OS_CMD,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,           KC_PGDN,
...
//        XXXXXXX, XXXXXXX, HYPR_1,  HYPR_2,  HYPR_3,  HYPR_4,  HYPR_5,  HYPR_6,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT,          XXXXXXX,
//        XXXXXXX, XXXXXXX, XXXXXXX, TO_SEC,  XXXXXXX, _K_RGB,  _K_MDTB, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          _K_MX_C,
//        XXXXXXX, KC_CAPS, _K_MDA,  XXXXXXX, XXXXXXX, _K_AFN,  XXXXXXX, XXXXXXX, XXXXXXX, _K_MX_O, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX,          XXXXXXX,
//        XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, _K_MDC,  XXXXXXX, _K_MDC2, XXXXXXX, TO_MAIN, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX,
//        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_SLEP,                   KC_SLEP,          XXXXXXX, XXXXXXX, XXXXXXX, KC_MPRV, XXXXXXX, KC_MNXT
    ...
    [_LAYER_SECONDARY] = LAYOUT_90_ansi(
        ...
        HYPR_F3,    OS_CMD,   KC_A,     KC_S,     KC_D,     KC_F,     KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,             KC_END,
        HYPR_F4,    KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
        HYPR_F5,    KC_LGUI,  KC_LALT,            KC_LCTL,  KC_SPC,   _______,             KC_SPC,             MO_WSP,             KC_RCTL,            KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
    ...
    [_LAYER_COMMANDS] = LAYOUT_90_ansi(
        RGB_TOG,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,            XXXXXXX,
        XXXXXXX,    XXXXXXX,  HYPR_1,   HYPR_2,   HYPR_3,   HYPR_4,   HYPR_5,    HYPR_6,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   QK_BOOT,  XXXXXXX,            XXXXXXX,
        ...
        XXXXXXX,    KC_CAPS,            XXXXXXX,  XXXXXXX,  _K_MDC,   XXXXXXX,   _K_MDC2,  XXXXXXX,  TO_MAIN,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,
